...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blog_content: Schema.Attribute.DynamicZone<
      ['blog.video-block', 'blog.text-image', 'blog.text-block']
    >;
    blog_status: Schema.Attribute.Enumeration<['draft', 'reviewed']> &
      Schema.Attribute.Required &
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    brands: Schema.Attribute.Relation<'oneToMany', 'api::customer.customer'>;
    brands_section: Schema.Attribute.Component<'home.section-header', false>;
    catalysts: Schema.Attribute.Component<'home.catalyst', true>;
    catalysts_section: Schema.Attribute.Component<'home.section-header', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    new_at: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'>;
    new_at_section: Schema.Attribute.Component<'home.section-header', false>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    work_that_work_section: Schema.Attribute.Component<
      'home.section-header',
      false
    >;
    work_that_work_sections: Schema.Attribute.Relation<
      'oneToMany',
      'api::project.project'
    >;
  };
...
export interface ApiMainMenuMainMenu extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    menu_items: Schema.Attribute.Component<'navigation.menu-item', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
